...
(function () {
  ...
  const zhToEn = {
    ...
    '展开全部标签': 'Show all tags',
    '收起标签': 'Show fewer tags',
    ...
    '最后一次': 'Last',
    '全部打开': 'Open all',
    '在新标签页打开当日全部题面': 'Open every due problem in new background tabs (current tab unchanged)',
    '没有可在浏览器打开的题面链接': 'No problem URLs to open',
    '当日复习': 'Today Review',
    '📋 当日复习': '📋 Today Review',
    '当日复习 ✓': 'Today Review ✓',
    '加入复习': 'Add Review',
    ...
    'eg. 0 3 10 30': 'eg. 0 3 10 30',
    'eg. 30 60 90': 'eg. 30 60 90',
    '将重置复习进度，历史记录会保留。': 'Review progress will be reset; your history is kept.',
  ...
  const zhPatterns = [
    ...
    [/^今天$/, 'Today'],
    [/^逾期 (\d+) 天$/, 'Overdue $1d'],
    [/^🔥 完整复习 \((\d+)次\)$/, '🔥 Full Plan ($1)'],
    [/^⚡ 精简复习 \((\d+)次\)$/, '⚡ Light Plan ($1)'],
    [/^补交\(\+(\d+)天\)$/, 'Late (+$1d)'],
